...
import org.vmorg.exceptions.MachineNotCreatedException;
import org.vmorg.exceptions.UserNotEntitledException;
...
public interface VirtualMachineRequestor {
     ...
     */
    void createNewRequest(VirtualMachine machine)
